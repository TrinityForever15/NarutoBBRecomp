...
# Codegen target - run 'cmake --build . --target narutobb_codegen'
# Uses the manifest to drive codegen for all modules (entrypoint + DLLs).
add_custom_target(narutobb_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/narutobb_manifest.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for narutobb"
    VERBATIM
)
