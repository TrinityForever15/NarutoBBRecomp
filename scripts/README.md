...
| `apply_rexglue_patches.ps1` | Validate the checkout and recreate the modified branch from the sixteen patches |
...
| `test_gpu_replay.ps1` | Replay the twelve approved local traces, compare public numeric baselines, skip unapproved exploratory captures, and write local JSON/CSV results |
